<div class="card-body">
	...
	<form method="post" action="?page=verify" class="row g-3">
		<div class="col-lg-12 form-floating">
			<input type="text" id="lname" name="lname" class="form-control" placeholder="Surname" pattern="[a-zA-Z ]+" required autocomplete="off">
			<label for="lname">Surname</label>
		</div>
		<div class="col-lg-12 form-floating">
			<input type="text" id="fname" name="fname" class="form-control" placeholder="First Name" pattern="[a-zA-Z ]+" required autocomplete="off">
			<label for="fname">First Name</label>
		</div>
		<div class="col-lg-12 form-floating">
			<input type="text" id="mname" name="mname" class="form-control" placeholder="Middle Name" pattern="[a-zA-Z ]+" autocomplete="off">
